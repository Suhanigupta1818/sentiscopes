...
st.markdown("""
<style>
section[data-testid="stSidebar"] > div {background-color: #0f172a !important;}
...
[data-testid="stSidebar"] .stRadio div {color: #e2e8f0 !important;}
...
div[data-testid="stMetric"] {background:#1e293b; padding:1rem; border-radius:10px; border:0.5px solid #334155;}
</style>
...
# ── METRICS ───────────────────────────────────────────────
    ...
    c1.metric("Accuracy",  "97.3%")
    c2.metric("F1 Score",  "0.97")
    c3.metric("Precision", "0.97")
    c4.metric("Recall",    "0.97")
    st.divider()
    import pandas as pd
